  ...
  const steps = [
    {
      ...
      description: 'Add the free extension to Chrome in one click.',
    },
    {
      number: '2',
      title: 'Flip the page',
      description: 'Click the Flipit icon on any webpage.',
    },
    {
      number: '3',
      title: 'Read and share',
      description: 'See reviews, warnings, and join the conversation.',
    },
  ];
  ...
  return (
    <section className="py-16 sm:py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p className="text-flipit-orange font-semibold text-center mb-12">
