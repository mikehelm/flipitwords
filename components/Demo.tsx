...
export default function Demo() {
  ...
  return (
    <section id="demo" className="py-16 sm:py-24 bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6">
            {/* Mock webpage */}
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl aspect-[4/3] flex items-center justify-center relative overflow-hidden border border-gray-700">
            ...
            {/* Flipit overlay */}
            <div className="bg-gray-900 border border-gray-700 rounded-xl shadow-xl p-6 space-y-4">
              ...
              {/* Official response */}
              <div className="border-2 border-flipit-orange/30 rounded-lg p-4 bg-flipit-orange/10">
                <div className="flex items-center gap-2 mb-2">
